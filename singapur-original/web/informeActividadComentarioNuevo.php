...
obj.value=obj.value.substring(0,mlength)
	...
	<input type="hidden" name="tablaComentario" class="campos" id="tablaComentario" value="<? echo $tablaComentario; ?>">
    <input type="hidden" name="idReferenciaComentario" class="campos" id="idReferenciaComentario" value="<? echo @$idReferenciaComentario; ?>">
    <input type="hidden" name="idUsuarioNotificado" class="campos" id="idUsuarioNotificado" value="<? echo $_REQUEST["idUsuarioNotificado"]; ?>">
    <input type="hidden" name="idActividad" class="campos" id="idActividad" value="<? echo $idActividad; ?>">
