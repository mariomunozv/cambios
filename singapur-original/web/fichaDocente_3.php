...
<table border="0" class="tablesorter" style="width:400px;">
	...
	<tr>
        ...
        <td colspan="3">
        	<table width="100%">
                <tr>
                    <td><input type="checkbox" name="cursoActual[]" id="cursoActual" value="1"/>1º Básico</td>
                    <td><input type="checkbox" name="cursoActual[]" id="cursoActual" value="5"/>5º Básico</td>
                </tr>
                <tr>
                    <td><input type="checkbox" name="cursoActual[]" id="cursoActual" value="2"/>2º Básico</td>
                    <td><input type="checkbox" name="cursoActual[]" id="cursoActual" value="6"/>6º Básico</td>
                </tr>
                <tr>
                    <td><input type="checkbox" name="cursoActual[]" id="cursoActual" value="3"/>3º Básico</td>
                    <td><input type="checkbox" name="cursoActual[]" id="cursoActual" value="7"/>7º Básico</td>
                </tr>
                <tr>
                    <td><input type="checkbox" name="cursoActual[]" id="cursoActual" value="4"/>4º Básico</td>
                    <td><input type="checkbox" name="cursoActual[]" id="cursoActual" value="8"/>8º Básico</td>
                </tr>
                <tr>
	...
	<tr>
        ...
        <td colspan="3">
        	<table width="100%">
                <tr>
                    <td><input type="radio" name="experienciaSingapur" id="experienciaSingapur" value="1"/>1 año</td>
                </tr>
                <tr>
                    <td><input type="radio" name="experienciaSingapur" id="experienciaSingapur" value="2"/>2 años</td>
                </tr>
                <tr>
                    <td><input type="radio" name="experienciaSingapur" id="experienciaSingapur" value="3"/>3 años</td>
                </tr>
                <tr>
                    <td><input type="radio" name="experienciaSingapur" id="experienciaSingapur" value="4"/>4 años</td>
                </tr>
                <tr>
    ...
    <tr>
        ...
        <td colspan="3">
        	<table width="100%">
                <tr>
                    <td><input type="checkbox" name="nivelExperiencia[]" id="nivelExperiencia" value="1"/>1º Básico</td>
                </tr>
                <tr>
                    <td><input type="checkbox" name="nivelExperiencia[]" id="nivelExperiencia" value="2"/>2º Básico</td>
                </tr>
                <tr>
                    <td><input type="checkbox" name="nivelExperiencia[]" id="nivelExperiencia" value="3"/>3º Básico</td>
                </tr>
                <tr>
                    <td><input type="checkbox" name="nivelExperiencia[]" id="nivelExperiencia" value="4"/>4º Básico</td>
                </tr>
			</table>
		</td>
	</tr>
