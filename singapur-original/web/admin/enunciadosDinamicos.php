...
for($i=0; $i < $cantidad; $i++)
{
	...
	?>
	<tr>
		<td valign='top'>Enunciado N° <? echo $num ?></td>
		<td><textarea name='enunciados[]' rows='2' cols='50' id='enunciados' class='campos'></textarea></td>
        <td><input name="respuestaCorrectaEnunciado_<? echo $i; ?>" type="text" class="campos"/></td>
		<td align='left' valign='top'>
        <select class="campos" id="abiertos_<? echo $i; ?>" name="abiertos_<? echo $i; ?>">
        ...
        <td>
        <select class="campos" id="tipoInputEnunciado_<? echo $i; ?>" name="tipoInputEnunciado_<? echo $i; ?>">
          <option value=""></option>
...
<input type="hidden" name="cantidad" value="<? echo $cantidad ?>" class="campos">
</tr>
</table>
