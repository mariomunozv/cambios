...
function upload(){ 
 ...
 alert(a);
 AJAXPOST("alumnoGuardaDirectivo.php",a+"modo=carga",division);
...
<form name="form" action="alumnoGuardaSostenedor.php" method="POST" enctype="multipart/form-data">
...
<input type="hidden"  name="idNivel" id="idNivel" value="<? echo $idNivel;?>" class="campos" />   
...
<input name="userfile" type="file"> 
       <a class="button" href="javascript:upload();"><span><div class="save">Enviar</div></span></a><br><br>
