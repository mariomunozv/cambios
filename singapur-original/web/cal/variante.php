...
<body>
	<div id="agenda">
		...
		<?
			...
			echo "<p style='font-size:13px;margin:20px;border:1px solid #312c2b;padding:20px'>El c&oacute;digo: <a href='codigonuevo.txt'>Míralo aquí</a></p>";
		?>
	</div>
	<script type="text/javascript">
/* ATENCION ESTE CODIGO NO TE HACE FALTA, SON MIS ESTADISTICAS */
